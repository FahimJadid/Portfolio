...
export default {
  ...
  theme: {
    extend: {
      ...
      backgroundImage: {
        about:
          "linear-gradient(135deg, rgba(244,244,246,0.8) 60%, rgba(10,10,10,0.2) 100%),url('/src/assets/backgrounds/black.jpg')",
        experience:
          "linear-gradient(135deg, rgba(244,244,246,0.1) 60%, rgba(10,10,10,0.8) 100%),url('/src/assets/backgrounds/laptop.jpg')",
        // experienceLight:
        ...
        tech: "linear-gradient(165deg, rgba(20,20,20,0.8) 100%, rgba(109,109,116,0.8) 100%), url('/src/assets/backgrounds/paris.jpg')",
      },
      fontFamily: {
